...
bounds.phase(iphase).initialstate.lower = [x11_0 x21_0 x30 8 0 0]; 
bounds.phase(iphase).initialstate.upper = [x11_0 x21_0 x30 8 0 0];
bounds.phase(iphase).state.lower        = [x11_Min x21_Min x3Min 1 -1 -10]; 
bounds.phase(iphase).state.upper        = [x11_Max x21_Max x3Max 20 1 10];
bounds.phase(iphase).finalstate.lower   = [5 -1 x3Min 1 -1 -10];
bounds.phase(iphase).finalstate.upper   = [5 1 x3Max 20 1 10];
...
guess.phase(iphase).state    = [[x11_0; x11_Max],[-1; x21_Max],[0; x3Max],[6;10],[-1;1],[0;10]];
...
bounds.phase(iphase).initialstate.lower = [5 -1 x3Min 6 -1 -10]; 
bounds.phase(iphase).initialstate.upper = [5 1 x3Max 20 1 10];
bounds.phase(iphase).state.lower        = [5 -1 x3Min 1 -1 -10]; 
bounds.phase(iphase).state.upper        = [16 10 x3Max 20 1 10];
bounds.phase(iphase).finalstate.lower   = [14 10 x3Min 1 -1 -10];
bounds.phase(iphase).finalstate.upper   = [16 10 x3Max 20 1 10];
...
guess.phase(iphase).time     = [t0; tmax]; 
guess.phase(iphase).state    = [[5; 16],[-1; 10],[x3Min; x3Max],[6;10],[-1;1],[0;10]];
guess.phase(iphase).control  = [[0; u1Max],[0; u2Max]];
...
bounds.phase(iphase).initialstate.lower = [14 10 x3Min 6 -1 -10]; 
bounds.phase(iphase).initialstate.upper = [16 10 x3Max 20 1 10];
bounds.phase(iphase).state.lower        = [14 10 x3Min 1 -1 -10]; 
bounds.phase(iphase).state.upper        = [16 15 x3Max 20 1 10];
bounds.phase(iphase).finalstate.lower   = [14 15 pi/2 1 -1 -10];
bounds.phase(iphase).finalstate.upper   = [16 15 pi/2 20 1 10];
...
guess.phase(iphase).time     = [t0; tmax]; 
guess.phase(iphase).state    = [[14; 16],[10; 15],[x3Min; x3Max],[6;10],[-1;1],[0;10]];
guess.phase(iphase).control  = [[0; u1Max],[0; u2Max]];
...
lf = 0.46;          % m
lr = 0.11;         % m
BF=4.03;CF=0.02;DF=1192.16;
BR=2.45;CR=0.02;DR=5414.88;
...
fFy=DF*sin(CF*atan(BF*aF));
fRy=DR*sin(CR*atan(BR*aR));
...
phaseout(iphase).dynamics = [dx1,dx2,dx3,dx4,dx5,dx6];
phaseout(iphase).path=sqrt((x2-10).^2+(x1-5).^2)-10;
